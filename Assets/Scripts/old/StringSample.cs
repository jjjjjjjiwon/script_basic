...
public class StringSample : MonoBehaviour
{
    void Start()
    {
        ...
        talk2 = $"I am {name}. I anm {age} years old.";
        //Debug.LogFormat("I am {0}. I anm {1} years old.", name, age);
        //Debug.Log($"I am {name}. I anm {age} years old.");
        ...
        void SelfIntro(string talkFormat, string tlak2, string name, int age)
        {
